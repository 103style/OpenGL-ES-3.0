...
public class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //编译
        final int vertexShaderId = OpenGLESShaderUtils.compileVertexShader(IoUtils.readShaderResource(R.raw.shader_vertex_camera));
        final int fragmentShaderId = OpenGLESShaderUtils.compileFragmentShader(IoUtils.readShaderResource(R.raw.shader_fragment_camera));
        //链接程序片段
